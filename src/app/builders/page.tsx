...
export const metadata: Metadata = {
  ...
  description:
    "8,500+ homes since 1998. C&S Plumbing partners with builders and general contractors across Lee, Collier, and Charlotte counties for new construction rough-in, top-out, trim, and commercial plumbing.",
  keywords: [
