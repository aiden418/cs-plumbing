...
const TRUST_BADGES = [
  ...
  "Best of Cape Coral 2025 — Leak Detection",
  "8,500+ Homes Built",
  "5-Star Rated",
];
  ...
  // ============================================
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Fully. C&S Plumbing holds two active Florida plumbing contractor licenses — CFC057076 and CFC1432485 — and is insured and bonded. We're family-owned, we've been part of this community since 1998, and you can verify both licenses on the Florida DBPR website.",
      },
    ],
    relatedPages: [
      { label: "Your North Fort Myers Plumber", href: "/north-fort-myers-plumber" },
  ...
  // ============================================
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Yes. Our Florida state plumbing contractor licenses (CFC057076 and CFC1432485) cover work throughout the state, including all of Collier County. We're fully insured, family-owned since 1998, and experienced with the permitting and HOA documentation requirements common in Naples communities.",
      },
    ],
    relatedPages: [
    ...
    faqs: [
      {
        ...
        answer:
          "Most Punta Gorda repipes run $4,000–$15,000. The main cost drivers are square footage, number of bathrooms and fixtures, one story versus two, and material choice (PEX versus CPVC). Waterfront homes in Punta Gorda Isles with three baths land higher in the range than a two-bath ranch in Charlotte Park. We provide free in-home estimates with a firm written price — not a per-hour guess.",
      },
      {
  ...
  // ============================================
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Yes. C&S Plumbing holds two active Florida state plumbing contractor licenses — CFC057076 and CFC1432485, both verifiable on the Florida DBPR website — authorizing work in every Florida jurisdiction including the City of Sanibel. We are fully insured and bonded, family-owned since 1998, and have plumbed and serviced homes across 8,500+ Lee County properties.",
      },
    ],
    relatedPages: [
      { label: "Emergency Plumber on Sanibel", href: "/emergency-plumber-sanibel" },
  ...
  // ============================================
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Yes. C&S Plumbing holds two active Florida state plumbing contractor licenses — CFC057076 and CFC1432485, verifiable on the Florida DBPR website — covering all plumbing work in the Village of Estero and unincorporated Lee County. We're family-owned, fully insured and bonded, and have been finding and fixing Southwest Florida leaks since 1998.",
      },
    ],
    relatedPages: [
      { label: "Water Heater Repair in Estero", href: "/water-heater-repair-estero" },
  ...
  // ============================================
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Yes. C&S Plumbing holds two active Florida state plumbing contractor licenses, CFC057076 and CFC1432485, both verifiable on the Florida DBPR website. We're fully insured, family-owned since 1998, and we pull the required permit and handle the inspection on every water heater replacement.",
      },
      {
  ...
  // ============================================
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Yes. C&S Plumbing of Lee holds two active Florida state plumbing contractor licenses, CFC057076 and CFC1432485, both verifiable on the Florida DBPR website. We're fully insured and have been family-owned since 1998, with more than 8,500 Southwest Florida homes behind us.",
      },
      {
  ...
  // ============================================
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Yes. C&S Plumbing holds two active Florida state plumbing contractor licenses — CFC057076 and CFC1432485 — which are valid throughout Florida, including Charlotte County, and verifiable on the Florida DBPR website. We're fully insured and have been family-owned since 1998.",
      },
      {
  ...
  // ============================================
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Yes. C&S Plumbing holds two active Florida state plumbing contractor licenses, CFC057076 and CFC1432485, both verifiable on the Florida DBPR website. We're fully insured, family-owned, and have served Lehigh Acres and the rest of Lee County since 1998. That coverage extends from a single clogged fixture to full drain line excavation and replacement, so the same licensed company can handle whatever the camera finds.",
      },
    ],
    relatedPages: [
      { label: "Emergency Plumber in Lehigh Acres", href: "/emergency-plumber-lehigh-acres" },
  ...
  // ============================================
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Yes. C&S Plumbing holds two active Florida state plumbing contractor licenses, CFC057076 and CFC1432485, verifiable on the Florida DBPR website. We're fully insured, family-owned since 1998, and have responded to every major storm event in Southwest Florida since Hurricane Charley in 2004.",
      },
    ],
    relatedPages: [
      { label: "Drain Cleaning in Lehigh Acres", href: "/drain-cleaning-lehigh-acres" },
  ...
  // ============================================
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Yes. C&S Plumbing of Lee holds two active Florida plumbing contractor licenses, CFC057076 and CFC1432485, both verifiable on the Florida DBPR website. We've served Fort Myers since 1998, we're fully insured, and every installation is done to code with proper supply, drain, and bypass connections.",
      },
      {
